/* Implementation of Bubble sort for 100, 1000,
...
Bubble :: output()
{
	...
	cout<<"\n The number of comparasions done in bubble sort is: "<<comparisions;
	delete[] p;
}
...
int main()
{
	...
	cout << "\n Time taken for bubble sort function is: " <<(stop_s-start_s)/double(CLOCKS_PER_SEC);
	cout<<"\n";
	return 0;
}
